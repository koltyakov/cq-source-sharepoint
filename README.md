...
spec:
  ...
  version: "v1.6.3" # provide the latest stable version
...
spec:
  ...
  registry: "github"
  path: "koltyakov/sharepoint"
  version: "v1.6.3" # https://github.com/koltyakov/cq-source-sharepoint/releases
  destinations: ["sqlite"]
  spec:
    auth:
      strategy: "ondemand"
...
Starting migration with 5 tables for: sharepoint (v1.0.0) -> [sqlite (v1.6.3)]
Migration completed successfully.
Starting sync for: sharepoint (v1.0.0) -> [sqlite (v1.6.3)]
